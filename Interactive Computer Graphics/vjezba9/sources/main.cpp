...
//    glPolygonMode( GL_FRONT_AND_BACK, GL_LINE );
    ...
    glm::mat4 model = glm::translate(one, glm::vec3(/*glava->mMinMax.x[0]-glava->mMinMax.x[1]*/1, 0, 0));
    glm::mat4 model2 = glm::translate(one, glm::vec3(0,0,1));
    ...
    renderer->instanceSetModelMatrix("kocka", model2);
